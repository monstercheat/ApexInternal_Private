...
HRESULT __stdcall hkPresent(IDXGISwapChain* pSwapChain, UINT SyncInterval, UINT Flags)
{
	...
	draw_text_outline_font(120, 10, ImColor(255, 155, 0, 255), "{ MONSTERCHEAT - PRIVATE }");
	//ImGui::GetBackgroundDrawList()->AddText(ImVec2(40, 20), ImColor(255, 0, 255, 255), "INTERNAL");
